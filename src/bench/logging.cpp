...
static void LogEscapeMessageSuspicious(benchmark::Bench& bench) {
    // Messages containing control characters and other suspicious content
    // Based on the test cases but made to look like real log messages
...
BENCHMARK(LogEscapeMessageNormal, benchmark::PriorityLevel::HIGH);
BENCHMARK(LogEscapeMessageSuspicious, benchmark::PriorityLevel::HIGH);
