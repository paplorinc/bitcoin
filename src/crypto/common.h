...
void WriteLE16(ByteType auto* ptr, const uint16_t x)
{
    const uint16_t v{htole16_internal(x)};
    memcpy(ptr, &v, 2);
}

void WriteLE32(ByteType auto* ptr, const uint32_t x)
{
    const uint32_t v{htole32_internal(x)};
    memcpy(ptr, &v, 4);
}

void WriteLE64(ByteType auto* ptr, const uint64_t x)
{
...
void WriteBE16(ByteType auto* ptr, const uint16_t x)
{
    const uint16_t v{htobe16_internal(x)};
    memcpy(ptr, &v, 2);
}

void WriteBE32(ByteType auto* ptr, const uint32_t x)
{
    const uint32_t v{htobe32_internal(x)};
    memcpy(ptr, &v, 4);
}

void WriteBE64(ByteType auto* ptr, const uint64_t x)
{
